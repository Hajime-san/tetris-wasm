...
#[derive(Debug)]
pub struct Prop {
  pub number: Block_Position,
  pub color: &'static str,
}

type Block_Position = [i32; 4];

// O-block
pub const O_NUMBER: Block_Position = [
  Number::A,
  Number::A + 1,
  Number::A + Number::ROW,
...
// I-block
pub const I_NUMBER: Block_Position = [
  Number::A,
  Number::A + Number::ROW,
...
// J-block
pub const J_NUMBER: Block_Position = [
  Number::A,
  Number::A + 1,
  Number::A + Number::ROW,
  Number::A + (Number::ROW * 2),
...
// L-block
pub const L_NUMBER: Block_Position = [
  Number::A,
  Number::A + 1,
  Number::A + Number::ROW + 1,
...
// T-block
pub const T_NUMBER: Block_Position = [
  Number::A,
  Number::A + Number::ROW,
  Number::A + Number::ROW + 1,
  Number::A + (Number::ROW * 2),
...
// S-block
pub const S_NUMBER: Block_Position = [
  Number::A,
  Number::A + Number::ROW,
  Number::A + Number::ROW + 1,
  Number::A + (Number::ROW * 2) + 1,
...
// Z-block
pub const Z_NUMBER: Block_Position = [
  Number::A + 1,
  Number::A + Number::ROW,
  Number::A + Number::ROW + 1,
  Number::A + (Number::ROW * 2),
